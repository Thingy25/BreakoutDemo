...
namespace CircleBreak
{
    public class UIManager : MonoBehaviour
    {
        ...
        void Update()
        {
            score.text = "X " + ScoreManager.Instance.Multiplier.ToString();
        ...
        {
            if (!resumeLayer.activeSelf)
                resumeLayer.SetActive(true);
            Time.timeScale = 0;
        }
